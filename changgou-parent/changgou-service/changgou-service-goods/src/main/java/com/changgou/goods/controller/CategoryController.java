...
public class CategoryController {
     ...
     * @return
     */
    @GetMapping("/getAllObject/{categoryId}")
    public Result<Map> getAllObject(@PathVariable(value = "categoryId") Integer categoryId) {
        Map<String, Object> map = categoryService.getAllObject(categoryId);
    ...
    public Result<List<Category>> findListByParentId(@PathVariable(value = "parentId") Integer parentId) {
