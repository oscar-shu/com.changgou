...
public class ParaController {
     ...
     * @return
     */
    @GetMapping("/findParasByCategoryId/{categoryId}")
    public Result<Para> findParasByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        List<Para> list = paraService.findParasByCategoryId(categoryId);
