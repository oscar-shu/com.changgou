...
public class SpecController {
     ...
     * @return
     */
    @GetMapping("/findSpecsByCategoryId/{categoryId}")
    public Result<Spec> findSpecsByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        List<Spec> list = specService.findSpecsByCategoryId(categoryId);
