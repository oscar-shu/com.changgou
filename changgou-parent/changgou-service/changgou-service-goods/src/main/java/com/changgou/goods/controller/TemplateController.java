...
public class TemplateController {
     ...
     * @return
     */
    @GetMapping("/findTempByCategoryId/{categoryId}")
    public Result<Template> findTempByCategoryId(@PathVariable(value = "categoryId") Integer categoryId) {
        Template template = templateService.findTempByCategoryId(categoryId);
